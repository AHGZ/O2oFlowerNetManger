...
public class SPUtils {
    ...
    public static final String FILLNAME = "fillname";//SP缓存的语音设置信息
    public static final String KEY_WD_VOICE_VOLUME = "voice_volume";//音量
    public static final String KEY_WD_VOICE_NEW = "new_order";//新订单
    public static final String KEY_WD_VOICE_TIMEOUT = "voice_timeout";//超时订单
