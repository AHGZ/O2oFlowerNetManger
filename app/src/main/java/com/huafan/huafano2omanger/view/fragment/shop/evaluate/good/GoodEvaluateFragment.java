...
public class GoodEvaluateFragment extends KFragment<IGoodEvaluateView, IGoodEvaluatePrenter> implements IGoodEvaluateView {
    ...
    private int page = 1;
    private String state = "1";//1为好评2为中评3为差评
    private String type = "0";//0订单评价 1商家评价
    private int count = 0;
    ...
    @Override
    public IGoodEvaluatePrenter createPresenter() {
        return new IGoodEvaluatePrenter();
    }
...
//        exListView.setIndicatorBounds(width-40, width-10);
//        exListView.setGroupIndicator(getActivity().getResources().getDrawable(R.drawable.expandablelistview_indicator));
