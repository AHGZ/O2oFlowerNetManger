...
public class AppHorizontalTextViewAlertDialog {
    ...
    public TextView et_right;
    private OnposClickLitener onposClickLitener;
    public TextView et_dividing_line;

    public AppHorizontalTextViewAlertDialog(Activity activity) {
    ...
    public AppHorizontalTextViewAlertDialog builder() {
        // 获取Dialog布局
        View view = LayoutInflater.from(context).inflate(R.layout.app_horizontal_textview_dialog, null);
        ...
        et_left = (TextView) view.findViewById(R.id.et_left);
        et_right = (TextView) view.findViewById(R.id.et_right);
    ...
    public AppHorizontalTextViewAlertDialog setTitle(String title) {
        showTitle = true;
        if ("".equals(title)) {
    ...
    public AppHorizontalTextViewAlertDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public AppHorizontalTextViewAlertDialog setPositiveButton(String text, OnposClickLitener onposClickLitener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText("确定");
        } else {
    ...
    public AppHorizontalTextViewAlertDialog setNegativeButton(String text, final View.OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("取消");
        } else {
