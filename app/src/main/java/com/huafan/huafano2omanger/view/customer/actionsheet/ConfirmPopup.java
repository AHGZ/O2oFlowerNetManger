...
* @Description: TODO 确认弹出框
* @author zhangpeisen
* @date 2016年9月7日 下午1:47:20 
*/
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected CharSequence titleText = "选择城市";
    protected int cancelTextColor = Color.parseColor("#7B838D");
    protected int submitTextColor =  Color.parseColor("#71ABE7");
    protected int titleTextColor =  Color.parseColor("#656565");
