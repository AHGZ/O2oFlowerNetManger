...
public class NegativeEvaluateFragment extends KFragment<INegativeEvaluateView,
        INegativeEvaluatePrenter> implements INegativeEvaluateView {
    ...
    @Override
    public INegativeEvaluatePrenter createPresenter() {
        return new INegativeEvaluatePrenter();
    }
