...
public class ActionSheet extends Fragment implements View.OnClickListener {
    ...
    public static Builder createBuilder(Context context,
                                        FragmentManager fragmentManager,int viewID) {
        return new Builder(context, fragmentManager,viewID);
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context, FragmentManager fragmentManager,int viewID) {
            mContext = context;
            ViewID = viewID;
    ...
    public interface ActionSheetListener {
        ...
        void onOtherButtonClick(ActionSheet actionSheet, int index, int viewId);
    }
