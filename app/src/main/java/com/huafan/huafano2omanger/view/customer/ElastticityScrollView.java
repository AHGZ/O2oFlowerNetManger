...
/**
 * @author zhangpeisen
 * @ClassName: ElastticityScrollView
 * @Description: TODO 回弹式滑动布局
 * @date 2016年9月3日 下午12:48:24
 */
public class ElastticityScrollView extends ScrollView {
    ...
    public ElastticityScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ElastticityScrollView(Context context, AttributeSet attrs, int defStyle) {
