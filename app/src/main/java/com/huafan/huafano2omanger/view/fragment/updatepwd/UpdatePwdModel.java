...
import com.huafan.huafano2omanger.service.CodeService;
...
public class UpdatePwdModel implements IModel {
     ...
     * @param phone
     */
    public void updateModel(String pwd, String phone, String code, final IModelImpl<ApiResponse<UpdatePwd>, UpdatePwd> listener) {
