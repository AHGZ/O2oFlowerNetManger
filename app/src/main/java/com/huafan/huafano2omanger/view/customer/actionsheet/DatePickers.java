 ...
 * @描述: 日期选择器
 * @创建人：zhangpeisen
 * @创建时间：2017/8/11 下午2:47
 * @修改人：zhangpeisen
 * @修改时间：2017/8/11 下午2:47
 * @修改备注：
 * @throws
 */
public class DatePickers extends WheelPicker{
    ...
    //设置固定时间
    public void setiMmobilizationTime(int year, int mouth, int day) {
     ...
     * @param day
     */
    public DatePickers(Activity activity, int year, int mouth, int day) {
        this(activity, Mode.YEAR_MONTH_DAY, year, mouth, day);
    }
     ...
     * @param day
     */
    public DatePickers(Activity activity, Mode mode, int year, int mouth, int day) {
        super(activity);
        this.mode = mode;
        this.year = year;
        this.mouth = mouth;
        ...
        for (int i1 = 1; i1 <= 31; i1++) {
            days.add(DateUtils.fillZero(i1));
        }
    }
     ...
     */
    public void setOnDatePickListener(OnYearMonthDayPickListener listener) {
    ...
    protected View makeCenterView() {
        ...
        yearView.setTextColor(textColorNormal, Color.parseColor("#333333"));
        yearView.setLineVisible(lineVisible);
        yearView.setLineColor(Color.parseColor("#333333"));
        ...
        yearTextView.setTextColor(Color.parseColor("#333333"));
        ...
        monthView.setTextColor(textColorNormal, Color.parseColor("#333333"));
        monthView.setLineVisible(lineVisible);
        monthView.setLineColor(Color.parseColor("#333333"));
        ...
        monthTextView.setTextColor(Color.parseColor("#333333"));
        ...
        dayView.setTextColor(textColorNormal, Color.parseColor("#333333"));
        dayView.setLineVisible(lineVisible);
        dayView.setLineColor(Color.parseColor("#333333"));
        ...
        dayTextView.setTextColor(Color.parseColor("#333333"));
        ...
        if (!mode.equals(Mode.MONTH_DAY)) {
            ...
            yearView.setOnWheelViewListener(new WheelView.OnWheelViewListener() {
                ...
                public void onSelected(boolean isUserScroll, int selectedIndex, String item) {
                    ...
                    //需要根据年份及月份动态计算天数
                    days.clear();
                    int maxDays = DateUtils.calculateDaysInMonth(stringToYearMonthDay(item),
                            stringToYearMonthDay(months.get(selectedMonthIndex)));
            ...
            public void onSelected(boolean isUserScroll, int selectedIndex, String item) {
                ...
                if (!mode.equals(Mode.YEAR_MONTH)) {
                    ...
                    int maxDays = DateUtils.calculateDaysInMonth(
                            stringToYearMonthDay(years.get(selectedYearIndex)), stringToYearMonthDay(item));
