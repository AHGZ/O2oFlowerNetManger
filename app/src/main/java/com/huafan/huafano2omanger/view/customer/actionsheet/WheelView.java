...
public class WheelView extends ScrollView {
     ...
     */
    public static final int TEXT_COLOR_FOCUS = Color.parseColor("#333333");
    /**
     * The constant TEXT_COLOR_NORMAL.
     */
    public static final int TEXT_COLOR_NORMAL = Color.parseColor("#9E9E9E");
    /**
     * The constant LINE_COLOR.
     */
    public static final int LINE_COLOR = Color.parseColor("#D7D7D7");
    /**
...
//        tv.setEllipsize(TextUtils.TruncateAt.END);
        ...
        if (0 == itemHeight) {
            ...
            LogUtils.e("", "itemHeight: " + itemHeight);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        LogUtils.e("", "w: " + w + ", h: " + h + ", oldw: " + oldw + ", oldh: " + oldh);
        viewWidth = w;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                LogUtils.e("", String.format("items=%s, offset=%s", items.size(), offset));
    ...
    private class ScrollerTask implements Runnable {
        ...
        public void run() {
            ...
            if (initialY - newY == 0) { // stopped
                ...
                LogUtils.e("", "initialY: " + initialY + ", remainder: " + remainder + ", divided: " + divided);
                if (remainder == 0) {
